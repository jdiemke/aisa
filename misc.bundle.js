...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/misc/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
module.exports = __webpack_require__.p + "9ab8cc0b50548d6322136e5429447362.png";
...
/***/ "./src/assets/heightmapSphere.png":
/*!****************************************!*\
  !*** ./src/assets/heightmapSphere.png ***!
  \****************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "c55143e127c426cd69827603bbd05978.png";
...
module.exports = __webpack_require__.p + "df5e31e77b9339c4d0b43d5664e5e3ed.png";
...
/***/ "./src/examples/misc/Application.ts":
/*!******************************************!*\
  !*** ./src/examples/misc/Application.ts ***!
  \******************************************/
/*! no static exports found */
...
const Scene_1 = __webpack_require__(/*! ./Scene */ "./src/examples/misc/Scene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new Scene_1.Scene());
...
const texture_1 = __webpack_require__(/*! ../../texture */ "./src/texture/index.ts");
class Scene extends AbstractScene_1.AbstractScene {
    constructor() {
        super(...arguments);
        this.skybox = {};
        // move
    ...
    init(framebuffer) {
        return Promise.all([
            this.createTexture(__webpack_require__(/*! ../../assets/spheremap.png */ "./src/assets/spheremap.png"), false).then(texture => this.spheremap = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/metall.png */ "./src/assets/metall.png"), false).then(texture => this.metal = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/logo.png */ "./src/assets/logo.png"), false).then(texture => this.texture = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/razor1911.png */ "./src/assets/razor1911.png"), true).then(texture => this.texture2 = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/heightmap.png */ "./src/assets/heightmap.png"), false).then(texture => this.heightmap = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/metalheadz.png */ "./src/assets/metalheadz.png"), false).then(texture => this.metalheadz = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/font.png */ "./src/assets/font.png"), true).then(texture => this.texture4 = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/atlantis.png */ "./src/assets/atlantis.png"), false).then(texture => this.texture5 = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/lens.png */ "./src/assets/lens.png"), true).then(texture => this.texture6 = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/ball2.png */ "./src/assets/ball2.png"), true).then(texture => this.texture7 = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/pandabear.png */ "./src/assets/pandabear.png"), false).then(texture => this.texture8 = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/battleofilona.png */ "./src/assets/battleofilona.png"), false).then(texture => this.texture9 = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/spark.png */ "./src/assets/spark.png"), true).then(texture => this.texture10 = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/ring.png */ "./src/assets/ring.png"), true).then(texture => this.texture11 = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/sky.png */ "./src/assets/sky.png"), true).then(texture => this.texture12 = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/bokeh.png */ "./src/assets/bokeh.png"), true).then(texture => this.texture13 = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/led.png */ "./src/assets/led.png"), false).then(texture => this.texture14 = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/revision.png */ "./src/assets/revision.png"), false).then(texture => this.revision = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/lab2.png */ "./src/assets/lab2.png"), false).then(texture => this.lab2 = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/skybox/skybox_back.png */ "./src/assets/skybox/skybox_back.png"), false).then(texture => this.skybox.back = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/skybox/skybox_down.png */ "./src/assets/skybox/skybox_down.png"), false).then(texture => this.skybox.down = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/skybox/skybox_front.png */ "./src/assets/skybox/skybox_front.png"), false).then(texture => this.skybox.front = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/skybox/skybox_left.png */ "./src/assets/skybox/skybox_left.png"), false).then(texture => this.skybox.left = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/skybox/skybox_right.png */ "./src/assets/skybox/skybox_right.png"), false).then(texture => this.skybox.right = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/skybox/skybox_up.png */ "./src/assets/skybox/skybox_up.png"), false).then(texture => this.skybox.up = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/platonian_baked.png */ "./src/assets/platonian_baked.png"), false).then(texture => this.platonian = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/meth.png */ "./src/assets/meth.png"), true).then(texture => this.meth = texture),
            ...
            this.createTexture(__webpack_require__(/*! ../../assets/hoodlumLogo.png */ "./src/assets/hoodlumLogo.png"), true).then(texture => this.hoodlumLogo = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/abstract.png */ "./src/assets/abstract.png"), false).then(texture => this.abstract = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/rave.png */ "./src/assets/rave.png"), false).then(texture => this.rave = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/microstrange.png */ "./src/assets/microstrange.png"), false).then(texture => this.micro = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/Backed.png */ "./src/assets/Backed.png"), false).then(texture => this.baked = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/blurredBackground.png */ "./src/assets/blurredBackground.png"), false).then(texture => this.blurred = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/hlm.png */ "./src/assets/hlm.png"), true).then(texture => this.hlm = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/cross.png */ "./src/assets/cross.png"), true).then(texture => this.cross = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/envmap.png */ "./src/assets/envmap.png"), false).then(texture => this.envmap = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/heightmapSphere.png */ "./src/assets/heightmapSphere.png"), false).then(texture => this.heightmapSphere = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/mask.png */ "./src/assets/mask.png"), true).then(texture => this.mask = texture),
            this.createTexture(__webpack_require__(/*! ../../assets/dirt.png */ "./src/assets/dirt.png"), true).then(texture => this.dirt = texture),
        ]).then(() => {
            // Web Audio API
            ...
            request.open('GET', __webpack_require__(/*! ../../assets/xmix_q2_final.ogg */ "./src/assets/xmix_q2_final.ogg"), true);
    ...
    render(framebuffer) {
        ...
        time = time * 3 + 550000;
        time = time % (1150000);
        framebuffer.setCullFace(CullFace_1.CullFace.FRONT);
        /*
             if (time < 30000) {
...
/******/ });
//# sourceMappingURL=misc.bundle.js.map