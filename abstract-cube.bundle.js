...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/abstract-cube/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/abstract-cube/AbstractCubeScene.ts":
/*!*********************************************************!*\
  !*** ./src/examples/abstract-cube/AbstractCubeScene.ts ***!
  \*********************************************************/
/*! no static exports found */
 ...
 */
class AbstractCubeScene extends AbstractScene_1.AbstractScene {
    constructor() {
        super(...arguments);
    ...
    init(framebuffer) {
        ...
        this.scene = BlenderJsonParser_1.BlenderJsonParser.parse(__webpack_require__(/*! ../../assets/stravaganza.json */ "./src/assets/stravaganza.json"), false);
        return Promise.all([
    ...
    drawBlenderScene2(framebuffer, elapsedTime) {
        ...
        let model = this.scene[0];
        this.renderingPipeline.draw(model, mv, 246, 165, 177);
        mv = camera.multiplyMatrix(math_1.Matrix4f.constructZRotationMatrix(Math.PI * 0.5 * framebuffer.cosineInterpolate(0, 600, Math.floor(elapsedTime * 0.7) % 4000))
            .multiplyMatrix(math_1.Matrix4f.constructXRotationMatrix(Math.PI * 0.5 * framebuffer.cosineInterpolate(2000, 2600, Math.floor(elapsedTime * 0.7) % 4000))));
        model = this.scene[1];
...
exports.AbstractCubeScene = AbstractCubeScene;


/***/ }),

/***/ "./src/examples/abstract-cube/Application.ts":
/*!***************************************************!*\
  !*** ./src/examples/abstract-cube/Application.ts ***!
  \***************************************************/
/*! no static exports found */
...
const AbstractCubeScene_1 = __webpack_require__(/*! ./AbstractCubeScene */ "./src/examples/abstract-cube/AbstractCubeScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new AbstractCubeScene_1.AbstractCubeScene());
...
/******/ });
//# sourceMappingURL=abstract-cube.bundle.js.map