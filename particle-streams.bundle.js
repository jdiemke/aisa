...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/particle-streams/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/particle-streams/Application.ts":
/*!******************************************************!*\
  !*** ./src/examples/particle-streams/Application.ts ***!
  \******************************************************/
/*! no static exports found */
...
const ParticleStreamsScene_1 = __webpack_require__(/*! ./ParticleStreamsScene */ "./src/examples/particle-streams/ParticleStreamsScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new ParticleStreamsScene_1.ParticleStreamsScene());
...
/***/ "./src/examples/particle-streams/ParticleStreamsScene.ts":
/*!***************************************************************!*\
  !*** ./src/examples/particle-streams/ParticleStreamsScene.ts ***!
  \***************************************************************/
/*! no static exports found */
 ...
 */
class ParticleStreamsScene extends AbstractScene_1.AbstractScene {
    constructor() {
        super(...arguments);
    ...
    init(framebuffer) {
        return Promise.all([
            ...
            texture_1.TextureUtils.generateProceduralParticleTexture().then(texture => this.particleTexture2 = texture),
    ...
    drawParticleStreams(framebuffer, elapsedTime, texture, noClear = false) {
        let points = new Array();
        const num = 50;
        const num2 = 10;
        const scale = 2.1;
        ...
        for (let i = 0; i < 3; i++) {
            ...
            points2.forEach(element => {
                ...
                let size = -(1.3 * 192 / (element.z));
                if (element.z < -4)
                    framebuffer.drawParticleNoDepth(Math.round(element.x - size / 2), Math.round(element.y - size / 2), Math.round(size), Math.round(size), texture, 1 / element.z, framebuffer.interpolate(-90, -55, element.z));
            });
        }
    }
}
exports.ParticleStreamsScene = ParticleStreamsScene;
...
/******/ });
//# sourceMappingURL=particle-streams.bundle.js.map