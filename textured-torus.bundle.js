...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/textured-torus/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/textured-torus/Application.ts":
/*!****************************************************!*\
  !*** ./src/examples/textured-torus/Application.ts ***!
  \****************************************************/
/*! no static exports found */
...
const TexturedTorusScene_1 = __webpack_require__(/*! ./TexturedTorusScene */ "./src/examples/textured-torus/TexturedTorusScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new TexturedTorusScene_1.TexturedTorusScene());
...
/***/ "./src/examples/textured-torus/TexturedTorusScene.ts":
/*!***********************************************************!*\
  !*** ./src/examples/textured-torus/TexturedTorusScene.ts ***!
  \***********************************************************/
/*! no static exports found */
...
const texture_1 = __webpack_require__(/*! ../../texture */ "./src/texture/index.ts");
const Vertex_1 = __webpack_require__(/*! ../../Vertex */ "./src/Vertex.ts");
class TexturedTorusScene extends AbstractScene_1.AbstractScene {
    init(framebuffer) {
        framebuffer.setCullFace(CullFace_1.CullFace.BACK);
        this.torusMesh = this.computeTexturedTorusMesh();
        return Promise.all([
            texture_1.TextureUtils.load(__webpack_require__(/*! ../../assets/font.png */ "./src/assets/font.png"), true).then(texture => this.texture4 = texture),
            texture_1.TextureUtils.load(__webpack_require__(/*! ../../assets/abstract.png */ "./src/assets/abstract.png"), false).then(texture => this.abstract = texture),
            texture_1.TextureUtils.load(__webpack_require__(/*! ../../assets/atlantis.png */ "./src/assets/atlantis.png"), false).then(texture => this.texture5 = texture),
        ]);
    }
    render(framebuffer) {
        const time = Date.now();
    ...
    shadingTorus4(framebuffer, elapsedTime) {
    ...
    computeTexturedTorusMesh() {
        ...
        for (let i = 0; i < STEPS + 1; i++) {
            ...
            for (let r = 0; r < STEPS2 + 1; r++) {
                let pos = up.mul(Math.sin(r * 2 * Math.PI / STEPS2)).add(right.mul(Math.cos(r * 2 * Math.PI / STEPS2))).add(frame);
                points.push(new math_1.Vector4f(pos.x, pos.y, pos.z));
        ...
        const torus = {
            points,
            points2: points.map(x => new math_1.Vector4f(0, 0, 0)),
            uv: textCoords,
            faces
        };
        return torus;
    }
    cinematicScroller(framebuffer, texture, time) {
        let scrollText = [
            '', '', '', '', '', '', '', '', '', '',
            '', '', '', '', '', '', '', '', '', '',
            '', '', '', '', '',
...
exports.TexturedTorusScene = TexturedTorusScene;
...
/******/ });
//# sourceMappingURL=textured-torus.bundle.js.map