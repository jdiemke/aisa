...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/torus-knot-tunnel/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/torus-knot-tunnel/Application.ts":
/*!*******************************************************!*\
  !*** ./src/examples/torus-knot-tunnel/Application.ts ***!
  \*******************************************************/
/*! no static exports found */
...
const TorusKnotTunnelScene_1 = __webpack_require__(/*! ./TorusKnotTunnelScene */ "./src/examples/torus-knot-tunnel/TorusKnotTunnelScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new TorusKnotTunnelScene_1.TorusKnotTunnelScene());
...
/***/ "./src/examples/torus-knot-tunnel/TorusKnotTunnelScene.ts":
/*!****************************************************************!*\
  !*** ./src/examples/torus-knot-tunnel/TorusKnotTunnelScene.ts ***!
  \****************************************************************/
/*! no static exports found */
...
class TorusKnotTunnelScene extends AbstractScene_1.AbstractScene {
    constructor() {
        super(...arguments);
        this.torusKnot = new TorusKnot_1.TorusKnot();
    ...
    init(framebuffer) {
        ...
        return Promise.all([
            ...
            texture_1.TextureUtils.generateProceduralParticleTexture2().then((texture) => this.particleTexture = texture),
        ]);
    }
    /**
     * TODO:
    ...
    torusTunnel(framebuffer, elapsedTime, sync, texture) {
        ...
        ppoints2.forEach(element => {
            ...
            if (element.z < -4)
                framebuffer.drawParticle(Math.round(element.x - size / 2), Math.round(element.y - size / 2), Math.round(size), Math.round(size), texture, 1 / element.z, framebuffer.interpolate(-90, -55, element.z));
        });
    }
...
exports.TorusKnotTunnelScene = TorusKnotTunnelScene;
...
/******/ });
//# sourceMappingURL=torus-knot-tunnel.bundle.js.map