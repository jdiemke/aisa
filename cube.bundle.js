...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/cube/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/cube/Application.ts":
/*!******************************************!*\
  !*** ./src/examples/cube/Application.ts ***!
  \******************************************/
/*! no static exports found */
...
const CubeScene_1 = __webpack_require__(/*! ./CubeScene */ "./src/examples/cube/CubeScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new CubeScene_1.CubeScene());
...
/***/ "./src/examples/cube/CubeScene.ts":
/*!****************************************!*\
  !*** ./src/examples/cube/CubeScene.ts ***!
  \****************************************/
/*! no static exports found */
 ...
 */
class CubeScene extends AbstractScene_1.AbstractScene {
    constructor() {
        super(...arguments);
        this.cubeMesh = new Cube_1.Cube();
    }
    init(framebuffer) {
    ...
    render(framebuffer) {
        const elapsedTime = Date.now() * 0.02;
    ...
    getModelViewMatrix(elapsedTime) {
        const scale = 3.2;
        return math_1.Matrix4f.constructTranslationMatrix(0, 0, -9).multiplyMatrix(math_1.Matrix4f.constructScaleMatrix(scale, scale, scale).multiplyMatrix(math_1.Matrix4f.constructYRotationMatrix(elapsedTime * 0.05)).multiplyMatrix(math_1.Matrix4f.constructXRotationMatrix(elapsedTime * 0.08)));
    }
}
CubeScene.BACKGROUND_COLOR = Color_1.Color.BLACK.toPackedFormat();
