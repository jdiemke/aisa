...
export default class Framebuffer {
    ...
    draw() {
        ...
        for (let i = 0; i < 200; i++) {
            ...
            let rot = Math.sin(a * 0.4 + i * 0.002) * Math.PI * 2;
            let x1 = (Math.sin(rot) * 50) | 0;
            let x2 = (Math.sin(Math.PI * 2 / 4 + rot) * 50) | 0;
            let x3 = (Math.sin(Math.PI * 2 / 4 * 2 + rot) * 50) | 0;
            let x4 = (Math.sin(Math.PI * 2 / 4 * 3 + rot) * 50) | 0;
