...
const labJson = <any> require('./../../assets/lab.json');

const hlm2018Json = <any>require('./../../assets/hoodlum2018.json');
...
export class MovingTorusScene extends AbstractScene {
    ...
    private blenderObj6: Array<FlatshadedMesh>;
    private blenderObj7: Array<FlatshadedMesh>;
    ...
    public init(framebuffer: Framebuffer): Promise<any> {
        ...
        this.blenderObj6 = BlenderJsonParser.parse(labJson, false);
        this.blenderObj7 = BlenderJsonParser.parse(hlm2018Json, false);
        return Promise.all([
    ...
    public render(framebuffer: Framebuffer): void {
        ...
        this.drawBlenderScene6(framebuffer, time);
    ...
    public drawBlenderScene6(framebuffer: Framebuffer, elapsedTime: number): void {
        ...
        points2.forEach(element => {
            ...
            framebuffer.drawSoftParticle(
                ...
                Math.round(size), Math.round(size), this.particleTexture2, 1 / element.z, 0.7);
        });
    }
