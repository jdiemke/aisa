...
export class Md2ModelScene extends AbstractScene {
    ...
    public render(framebuffer: Framebuffer): void {
        ...
        // framebuffer.texturedRenderingPipeline.draw(this.mdl.getMesh(), this.modelViewMatrix.getMatrix());

        framebuffer.drawText(8,  8, 'FPS: ' + this.fps.toString(), this.texture4);
        // framebuffer.drawText(8, 16, 'TRIANGELS: ' + this.mdl.header.numberOfTriangles, this.texture4);
    }
