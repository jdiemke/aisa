...
/***/ "./src/examples/torus/Application.ts":
/*!*******************************************!*\
  !*** ./src/examples/torus/Application.ts ***!
  \*******************************************/
/*! no static exports found */
...
const TorusScene_1 = __webpack_require__(/*! ./TorusScene */ "./src/examples/torus/TorusScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new TorusScene_1.TorusScene());
...
/***/ "./src/examples/torus/TorusScene.ts":
/*!******************************************!*\
  !*** ./src/examples/torus/TorusScene.ts ***!
  \******************************************/
/*! no static exports found */
...
const math_1 = __webpack_require__(/*! ../../math */ "./src/math/index.ts");
const Torus_1 = __webpack_require__(/*! ../../geometrical-objects/Torus */ "./src/geometrical-objects/Torus.ts");
class TorusScene extends AbstractScene_1.AbstractScene {
    constructor() {
        super(...arguments);
        this.torus = new Torus_1.Torus();
    }
    init(framebuffer) {
        ...
        return Promise.all([
            texture_1.TextureUtils.load(__webpack_require__(/*! ./assets/razor1911.png */ "./src/examples/torus/assets/razor1911.png"), true).then((texture) => this.razorLogo = texture)
        ]);
    }
    render(framebuffer) {
        const time = Date.now();
    ...
    shadingTorus(framebuffer, elapsedTime) {
...
exports.TorusScene = TorusScene;


/***/ }),

/***/ "./src/examples/torus/assets/razor1911.png":
/*!*************************************************!*\
  !*** ./src/examples/torus/assets/razor1911.png ***!
  \*************************************************/
/*! no static exports found */
...
/******/ });
//# sourceMappingURL=torus.bundle.js.map