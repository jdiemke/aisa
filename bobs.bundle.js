...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/bobs/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/bobs/Application.ts":
/*!******************************************!*\
  !*** ./src/examples/bobs/Application.ts ***!
  \******************************************/
/*! no static exports found */
...
const BobScene_1 = __webpack_require__(/*! ./BobScene */ "./src/examples/bobs/BobScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new BobScene_1.BobScene());
 ...
 */
class BobScene extends AbstractScene_1.AbstractScene {
    init(framebuffer) {
        return Promise.all([
            ...
            texture_1.TextureUtils.load(__webpack_require__(/*! ../../assets/ball2.png */ "./src/assets/ball2.png"), true).then(texture => this.texture7 = texture),
        ]);
    }
    render(framebuffer) {
    ...
    drawBobs(framebuffer, texture, time) {
...
/******/ });
//# sourceMappingURL=bobs.bundle.js.map