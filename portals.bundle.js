...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/portals/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/camera/ControllableCamera.ts":
/*!******************************************!*\
  !*** ./src/camera/ControllableCamera.ts ***!
  \******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const BasicCamera_1 = __webpack_require__(/*! ./BasicCamera */ "./src/camera/BasicCamera.ts");
...
Object.defineProperty(exports, "__esModule", { value: true });
var BasicCamera_1 = __webpack_require__(/*! ./BasicCamera */ "./src/camera/BasicCamera.ts");
exports.BasicCamera = BasicCamera_1.BasicCamera;
var ControllableCamera_1 = __webpack_require__(/*! ./ControllableCamera */ "./src/camera/ControllableCamera.ts");
exports.ControllableCamera = ControllableCamera_1.ControllableCamera;


/***/ }),

/***/ "./src/clustered-culling/FrustumCuller.ts":
/*!************************************************!*\
  !*** ./src/clustered-culling/FrustumCuller.ts ***!
  \************************************************/
/*! no static exports found */
...
const Plane_1 = __webpack_require__(/*! ../math/Plane */ "./src/math/Plane.ts");
class FrustumCuller {
    constructor() {
        this.planes = new Array();
        for (let i = 0; i < 4; i++) {
            this.planes.push(new Plane_1.Plane(new index_1.Vector4f(0, 0, 0, 0), 0));
        }
        ...
        const vertices = [
            new index_1.Vector4f(-160 / 2, -100 / 2, 292),
            new index_1.Vector4f(160 / 2, -100 / 2, 292),
            new index_1.Vector4f(160 / 2, 100 / 2, 292),
            new index_1.Vector4f(-160 / 2, 100 / 2, 292),
        ];
        for (let i = 0; i < vertices.length; i++) {
            const normal = vertices[i].cross(vertices[(i + 1) % vertices.length]).normalize().mul(-1);
...
/***/ "./src/examples/portals/Application.ts":
/*!*********************************************!*\
  !*** ./src/examples/portals/Application.ts ***!
  \*********************************************/
/*! no static exports found */
...
const PortalScene_1 = __webpack_require__(/*! ./PortalScene */ "./src/examples/portals/PortalScene.ts");
class Application {
    main() {
        const canvas = new Canvas_1.Canvas(320, 200, new PortalScene_1.PortalScene());
...
/***/ "./src/examples/portals/PortalScene.ts":
/*!*********************************************!*\
  !*** ./src/examples/portals/PortalScene.ts ***!
  \*********************************************/
/*! no static exports found */
...
const FrustumCuller_1 = __webpack_require__(/*! ../../clustered-culling/FrustumCuller */ "./src/clustered-culling/FrustumCuller.ts");
const Color_1 = __webpack_require__(/*! ../../core/Color */ "./src/core/Color.ts");
const CullFace_1 = __webpack_require__(/*! ../../CullFace */ "./src/CullFace.ts");
const math_1 = __webpack_require__(/*! ../../math */ "./src/math/index.ts");
const portal_system_1 = __webpack_require__(/*! ../../portal-system */ "./src/portal-system/index.ts");
const AbstractScene_1 = __webpack_require__(/*! ../../scenes/AbstractScene */ "./src/scenes/AbstractScene.ts");
class PortalScene extends AbstractScene_1.AbstractScene {
    init(framebuffer) {
        framebuffer.setCullFace(CullFace_1.CullFace.BACK);
        this.controllableCamera = new camera_1.ControllableCamera(new math_1.Vector3f(14.84, 0, -19.25), -3.54, 0, 0);
        this.area = this.generateAreaPortalNetwork();
        this.frustumCuller = new FrustumCuller_1.FrustumCuller();
        this.portalRenderer = new portal_system_1.PortalRenderer();
    ...
    render(framebuffer) {
        ...
        const modelViewMartrix = this.controllableCamera.getViewMatrix();
     ...
     */
    generateAreaPortalNetwork() {
        const polygon2 = new portal_system_1.Polygon();
        polygon2.vertices = [new math_1.Vector4f(0, 5 - 2, 3), new math_1.Vector4f(10, 5 - 2, 3), new math_1.Vector4f(10, -5 - 2, 3)];
        const portal2 = new portal_system_1.Portal();
        portal2.geometry = polygon2;
        portal2.intoArea = new portal_system_1.Area();
        const area2 = new portal_system_1.Area();
        area2.portals = [portal2];
        const polygon = new portal_system_1.Polygon();
        polygon.vertices = [new math_1.Vector4f(0, 5, 0), new math_1.Vector4f(10, 5, 0), new math_1.Vector4f(10, -5, 0)];
        const portal = new portal_system_1.Portal();
        portal.geometry = polygon;
        portal.intoArea = area2;
        const area = new portal_system_1.Area();
        area.mesh = null;
        area.portals = [portal];
        area.portalColor = Color_1.Color.RED;
        return area;
    }
    drawScreenBounds(framebuffer) {
        const color = Color_1.Color.WHITE.toPackedFormat();
...
PortalScene.BACKGROUND_COLOR = Color_1.Color.SLATE_GRAY.toPackedFormat();
exports.PortalScene = PortalScene;
...
class Plane {
    ...
    computeIntersection(p1, p2) {
        const dot1 = p1.dot(this.normal);
        const dot2 = p2.dot(this.normal);
        const scale = (this.distance - dot1) / (dot2 - dot1);
...
class Polygon {
    ...
    getPlanes(pos) {
        const frustum = new Array();
        const position = new math_1.Vector4f(pos.x, pos.y, pos.z);
        for (let i = 0; i < this.vertices.length; i++) {
            const normal = this.vertices[i]
                .sub(position).cross(this.vertices[(i + 1) % this.vertices.length].sub(position)).normalize().mul(-1);
            const distance = normal.dot(position);
            frustum.push(new Plane_1.Plane(normal, distance));
        }
        return frustum;
    }
    isVisible() {
...
/***/ "./src/portal-system/PortalRenderer.ts":
/*!*********************************************!*\
  !*** ./src/portal-system/PortalRenderer.ts ***!
  \*********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const math_1 = __webpack_require__(/*! ../math */ "./src/math/index.ts");
const SutherlandHodgmanClipper_1 = __webpack_require__(/*! ./SutherlandHodgmanClipper */ "./src/portal-system/SutherlandHodgmanClipper.ts");
const Color_1 = __webpack_require__(/*! ../core/Color */ "./src/core/Color.ts");
class PortalRenderer {
     ...
     */
    renderVisibleAreas(framebuffer, modelViewMatrix, area, clipPlanes, controllableCamera) {
        ...
        for (let i = 0; i < area.portals.length; i++) {
            ...
            // 2.  
            const clippedPortalGeometry = SutherlandHodgmanClipper_1.SutherlandHodgmanClipper.clip(portal.geometry, clipPlanes);
            if (!clippedPortalGeometry.isVisible()) {
                continue;
            }
            this.drawPolygon(framebuffer, 0, clippedPortalGeometry, modelViewMatrix, area.portalColor ? area.portalColor : Color_1.Color.CYAN);
    ...
    drawPolygon(framebuffer, elapsedTime, polygon, matrix, color) {
        framebuffer.clearDepthBuffer();
...
/***/ "./src/portal-system/SutherlandHodgmanClipper.ts":
/*!*******************************************************!*\
  !*** ./src/portal-system/SutherlandHodgmanClipper.ts ***!
  \*******************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const Polygon_1 = __webpack_require__(/*! ./Polygon */ "./src/portal-system/Polygon.ts");
/**
 ...
 */
class SutherlandHodgmanClipper {
    static clip(polygon, planes) {
        let output = polygon.vertices;
        ...
        return new Polygon_1.Polygon(output);
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
var Area_1 = __webpack_require__(/*! ./Area */ "./src/portal-system/Area.ts");
exports.Area = Area_1.Area;
var Polygon_1 = __webpack_require__(/*! ./Polygon */ "./src/portal-system/Polygon.ts");
exports.Polygon = Polygon_1.Polygon;
var Portal_1 = __webpack_require__(/*! ./Portal */ "./src/portal-system/Portal.ts");
exports.Portal = Portal_1.Portal;
var PortalRenderer_1 = __webpack_require__(/*! ./PortalRenderer */ "./src/portal-system/PortalRenderer.ts");
exports.PortalRenderer = PortalRenderer_1.PortalRenderer;
var SutherlandHodgmanClipper_1 = __webpack_require__(/*! ./SutherlandHodgmanClipper */ "./src/portal-system/SutherlandHodgmanClipper.ts");
exports.SutherlandHodgmanClipper = SutherlandHodgmanClipper_1.SutherlandHodgmanClipper;
...
/******/ });
//# sourceMappingURL=portals.bundle.js.map