...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/lens/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/lens/Application.ts":
/*!******************************************!*\
  !*** ./src/examples/lens/Application.ts ***!
  \******************************************/
/*! no static exports found */
...
const LensScene_1 = __webpack_require__(/*! ./LensScene */ "./src/examples/lens/LensScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new LensScene_1.LensScene());
...
/***/ "./src/examples/lens/LensScene.ts":
/*!****************************************!*\
  !*** ./src/examples/lens/LensScene.ts ***!
  \****************************************/
/*! no static exports found */
 ...
 */
class LensScene extends AbstractScene_1.AbstractScene {
    init(framebuffer) {
        return Promise.all([
            texture_1.TextureUtils.load(__webpack_require__(/*! ./assets/atlantis.png */ "./src/examples/lens/assets/atlantis.png"), false).then((texture) => this.texture5 = texture),
            texture_1.TextureUtils.load(__webpack_require__(/*! ./assets/lens.png */ "./src/examples/lens/assets/lens.png"), true).then((texture) => this.texture6 = texture),
        ]);
    }
    render(framebuffer) {
        const time = Date.now();
    ...
    drawLens(framebuffer, texture, tex, time) {
        const radius = 47;
...
exports.LensScene = LensScene;


/***/ }),

/***/ "./src/examples/lens/assets/atlantis.png":
/*!***********************************************!*\
  !*** ./src/examples/lens/assets/atlantis.png ***!
  \***********************************************/
/*! no static exports found */
...
/***/ "./src/examples/lens/assets/lens.png":
/*!*******************************************!*\
  !*** ./src/examples/lens/assets/lens.png ***!
  \*******************************************/
/*! no static exports found */
...
/******/ });
//# sourceMappingURL=lens.bundle.js.map