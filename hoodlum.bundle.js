...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/hoodlum/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/hoodlum/Application.ts":
/*!*********************************************!*\
  !*** ./src/examples/hoodlum/Application.ts ***!
  \*********************************************/
/*! no static exports found */
...
const HoodlumScene_1 = __webpack_require__(/*! ./HoodlumScene */ "./src/examples/hoodlum/HoodlumScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new HoodlumScene_1.HoodlumScene());
...
/***/ "./src/examples/hoodlum/HoodlumScene.ts":
/*!**********************************************!*\
  !*** ./src/examples/hoodlum/HoodlumScene.ts ***!
  \**********************************************/
/*! no static exports found */
...
class HoodlumScene extends AbstractScene_1.AbstractScene {
    constructor() {
        super(...arguments);
        this.accumulationBuffer = new Uint32Array(320 * 200);
    }
    init(framebuffer) {
        this.spaceLabMesh = framebuffer.getBlenderScene(__webpack_require__(/*! ../../assets/lab2.json */ "./src/assets/lab2.json"), false);
        this.hoodlumLogoMesh = BlenderJsonParser_1.BlenderJsonParser.parse(__webpack_require__(/*! ../../assets/hoodlum2018.json */ "./src/assets/hoodlum2018.json"), false);
        return Promise.all([
            ...
            texture_1.TextureUtils.load(__webpack_require__(/*! ../../assets/lab2.png */ "./src/assets/lab2.png"), false).then(texture => this.lab2 = texture),
    ...
    drawBlenderScene9(framebuffer, elapsedTime, texture3) {
        ...
        framebuffer.renderingPipeline.draw(model, mv, 244, 100, 116);
        let points = new Array();
        const num = 10;
        const num2 = 6;
        for (let i = 0; i < num; i++) {
        ...
        points2.forEach(element => {
            let size = -(4.3 * 192 / (element.z));
            framebuffer.drawSoftParticle(Math.round(element.x - size / 2), Math.round(element.y - size / 2), Math.round(size), Math.round(size), texture3, 1 / element.z, 0.7);
        });
    }
...
exports.HoodlumScene = HoodlumScene;
...
/******/ });
//# sourceMappingURL=hoodlum.bundle.js.map