...
const Texture_1 = __webpack_require__(11);
class Canvas {
...
Object.defineProperty(exports, "__esModule", { value: true });
const ControllableCamera_1 = __webpack_require__(6);
const Vector3f_1 = __webpack_require__(0);
const Vector4f_1 = __webpack_require__(2);
const Matrix3_1 = __webpack_require__(8);
const Matrix4f_1 = __webpack_require__(1);
const RandomNumberGenerator_1 = __webpack_require__(9);
let json = __webpack_require__(10);
...
class RightEdge extends AbstractClipEdge {
    ...
    computeIntersection(p1, p2) {
        return new Vector3f_1.default(Framebuffer.maxWindow.x + 1, Math.round(p1.y + (p2.y - p1.y) * (Framebuffer.maxWindow.x + 1 - p1.x) / (p2.x - p1.x)), Math.round(1 / (1 / p1.z + (1 / p2.z - 1 / p1.z) * (Framebuffer.maxWindow.x + 1 - p1.x) / (p2.x - p1.x))));
    }
}
class LeftEdge extends AbstractClipEdge {
    ...
    computeIntersection(p1, p2) {
        return new Vector3f_1.default(Framebuffer.minWindow.x, Math.round(p1.y + (p2.y - p1.y) * (Framebuffer.minWindow.x - p1.x) / (p2.x - p1.x)), Math.round(1 / (1 / p1.z + (1 / p2.z - 1 / p1.z) * (Framebuffer.minWindow.x - p1.x) / (p2.x - p1.x))));
    }
}
class TopEdge extends AbstractClipEdge {
    ...
    computeIntersection(p1, p2) {
        return new Vector3f_1.default(Math.round(p1.x + (p2.x - p1.x) * (Framebuffer.maxWindow.y - p1.y) / (p2.y - p1.y)), Framebuffer.maxWindow.y, Math.round(1 / (1 / p1.z + (1 / p2.z - 1 / p1.z) * (Framebuffer.maxWindow.y - p1.y) / (p2.y - p1.y))));
    }
}
class BottomEdge extends AbstractClipEdge {
    ...
    computeIntersection(p1, p2) {
        return new Vector3f_1.default(Math.round(p1.x + (p2.x - p1.x) * (Framebuffer.minWindow.y - p1.y) / (p2.y - p1.y)), Framebuffer.minWindow.y, Math.round(1 / (1 / p1.z + (1 / p2.z - 1 / p1.z) * (Framebuffer.minWindow.y - p1.y) / (p2.y - p1.y))));
    }
}
class Framebuffer {
    constructor(width, height) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const Vector3f_1 = __webpack_require__(0);
const BasicCamera_1 = __webpack_require__(7);
