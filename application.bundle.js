...
const Vector4f_1 = __webpack_require__(2);
class Matrix4f {
...
Object.defineProperty(exports, "__esModule", { value: true });
const AISA = __webpack_require__(4);
...
Object.defineProperty(exports, "__esModule", { value: true });
const Framebuffer_1 = __webpack_require__(5);
const Texture_1 = __webpack_require__(12);
class Canvas {
    ...
    render() {
        ...
        this.framebuffer.setBob(this.texture3);
        this.framebuffer.fastFramebufferCopy(this.framebuffer.framebuffer, this.texture5.texture);
        this.framebuffer.shadingTorus4(time * 0.005);
        // this.framebuffer.fastFramebufferCopy(this.framebuffer.framebuffer, this.texture5.texture);
        // this.framebuffer.shadingTorus2(time * 0.02);
    ...
    init() {
        this.createTexture(__webpack_require__(13), false).then((texture) => {
            ...
            img2.addEventListener("load", () => {
                ...
                img3.addEventListener("load", () => {
                    this.texture3 = new Texture_1.default();
                    ...
                    img4.addEventListener("load", () => {
                        this.texture4 = new Texture_1.default();
                        ...
                        img5.addEventListener("load", () => {
                            this.texture5 = new Texture_1.default();
                            ...
                            img6.addEventListener("load", () => {
                                this.texture6 = new Texture_1.default();
                                ...
                                img7.addEventListener("load", () => {
                                    this.texture7 = new Texture_1.default();
                                    ...
                                    img8.addEventListener("load", () => {
                                        this.texture8 = new Texture_1.default();
                                                    ...
                                                    img12.addEventListener("load", () => {
                                                        ...
                                                        img13.addEventListener("load", () => {
                                                            ...
                                                            img14.addEventListener("load", () => {
                                                                ...
                                                                let myAudio = new Audio(__webpack_require__(14));
                                                                myAudio.loop = true;
                                                                this.start = Date.now();
                                                                myAudio.play();
                                                                this.renderLoop(0);
                                                            });
                                                            img14.src = __webpack_require__(15);
                                                        });
                                                        img13.src = __webpack_require__(16);
                                                    });
                                                    img12.src = __webpack_require__(17);
                                                });
                                                img11.src = __webpack_require__(18);
                                            });
                                            img10.src = __webpack_require__(19);
                                        });
                                        img9.src = __webpack_require__(20);
                                    });
                                    img8.src = __webpack_require__(21);
                                });
                                img7.src = __webpack_require__(22);
                            });
                            img6.src = __webpack_require__(23);
                        });
                        img5.src = __webpack_require__(24);
                    });
                    img4.src = __webpack_require__(25);
                });
                img3.src = __webpack_require__(26);
            });
            img2.src = __webpack_require__(27);
        });
    }
    display() {
    }
...
const ControllableCamera_1 = __webpack_require__(7);
const Vector3f_1 = __webpack_require__(0);
const Vector4f_1 = __webpack_require__(2);
const Matrix3_1 = __webpack_require__(9);
const Matrix4f_1 = __webpack_require__(1);
const RandomNumberGenerator_1 = __webpack_require__(10);
...
class Framebuffer {
        ...
        for (let i = 0; i < index.length; i += 3) {
            ...
            if (this.isTriangleCCW(v1, v2, v3)) {
                ...
                if (v1.x < Framebuffer.minWindow.x ||
                    ...
                    this.clipConvexPolygon(new Array(v1, v2, v3), color);
                }
                else {
                    this.drawTriangleDDA(v1, v2, v3, color);
    ...
    shadingTorus4(elapsedTime) {
        ...
        modelViewMartrix = Matrix4f_1.default.constructTranslationMatrix(Math.sin(elapsedTime * 0.1) * 26, Math.sin(elapsedTime * 0.2) * 10, -49)
            .multiplyMatrix(modelViewMartrix);
        for (let p = 0; p < points.length; p++) {
            let transformed = modelViewMartrix.multiply(points[p]);
            let x = transformed.x;
        ...
        for (let i = 0; i < index.length; i += 3) {
            ...
            if (this.isTriangleCCW(v1, v2, v3)) {
                ...
                if (v1.x < Framebuffer.minWindow.x ||
                    ...
                    v2.y > Framebuffer.maxWindow.y ||
                    v3.y > Framebuffer.maxWindow.y) {
                    this.clipConvexPolygon2(new Array(vertex1, vertex2, vertex3), color);
                }
                else {
                    // this.drawTriangleDDA(v1, v2, v3, color);
     ...
     * @memberof Framebuffer
     */
    clipConvexPolygon(subject, color) {
        let output = subject;
...
Object.defineProperty(exports, "__esModule", { value: true });
const Vector3f_1 = __webpack_require__(0);
const BasicCamera_1 = __webpack_require__(8);
