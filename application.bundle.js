...
var Matrix3_1 = __webpack_require__(13);
exports.Matrix3f = Matrix3_1.Matrix3f;
var Matrix4f_1 = __webpack_require__(4);
...
Object.defineProperty(exports, "__esModule", { value: true });
var BasicCamera_1 = __webpack_require__(6);
...
Object.defineProperty(exports, "__esModule", { value: true });
const AISA = __webpack_require__(10);
class Application {
    main() {
...
const Framebuffer_1 = __webpack_require__(11);
const Matrix4f_1 = __webpack_require__(4);
const RandomNumberGenerator_1 = __webpack_require__(8);
...
class Canvas {
    ...
    render() {
        ...
        */
        ...
        if (time < 50000) {
            ...
            let scale = 3.7;
            let elapsedTime = (time - 50000) * 0.0002;
            let modelViewMartrix = Matrix4f_1.Matrix4f.constructScaleMatrix(scale, scale, scale).multiplyMatrix(Matrix4f_1.Matrix4f.constructYRotationMatrix(elapsedTime * 0.35)
                .multiplyMatrix(Matrix4f_1.Matrix4f.constructXRotationMatrix(elapsedTime * 0.3)));
            modelViewMartrix = Matrix4f_1.Matrix4f.constructTranslationMatrix(-0, -0, -10 - (Math.sin(elapsedTime * 0.3) * 0.5 + 0.5) * 6)
    ...
    init() {
        ...
        Promise.all([
            this.createTexture(__webpack_require__(28), false).then(texture => this.spheremap = texture),
            this.createTexture(__webpack_require__(29), false).then(texture => this.metal = texture),
            this.createTexture(__webpack_require__(30), false).then(texture => this.texture = texture),
            this.createTexture(__webpack_require__(31), true).then(texture => this.texture2 = texture),
            this.createTexture(__webpack_require__(32), false).then(texture => this.heightmap = texture),
            this.createTexture(__webpack_require__(33), true).then(texture => this.texture4 = texture),
            this.createTexture(__webpack_require__(34), false).then(texture => this.texture5 = texture),
            this.createTexture(__webpack_require__(35), true).then(texture => this.texture6 = texture),
            this.createTexture(__webpack_require__(36), true).then(texture => this.texture7 = texture),
            this.createTexture(__webpack_require__(37), false).then(texture => this.texture8 = texture),
            this.createTexture(__webpack_require__(38), false).then(texture => this.texture9 = texture),
            this.createTexture(__webpack_require__(39), true).then(texture => this.texture10 = texture),
            this.createTexture(__webpack_require__(40), true).then(texture => this.texture11 = texture),
            this.createTexture(__webpack_require__(41), true).then(texture => this.texture12 = texture),
            this.createTexture(__webpack_require__(42), true).then(texture => this.texture13 = texture),
            this.createTexture(__webpack_require__(43), false).then(texture => this.texture14 = texture),
            this.createTexture(__webpack_require__(44), false).then(texture => this.revision = texture),
            this.createTexture(__webpack_require__(45), true).then(texture => this.meth = texture),
            ...
            this.createTexture(__webpack_require__(46), true).then(texture => this.hoodlumLogo = texture),
            this.createTexture(__webpack_require__(47), false).then(texture => this.abstract = texture),
            this.createTexture(__webpack_require__(48), false).then(texture => this.rave = texture),
            this.createTexture(__webpack_require__(49), false).then(texture => this.micro = texture),
            this.createTexture(__webpack_require__(50), false).then(texture => this.blurred = texture),
            this.createTexture(__webpack_require__(51), true).then(texture => this.hlm = texture),
            this.createTexture(__webpack_require__(52), true).then(texture => this.cross = texture),
            this.createTexture(__webpack_require__(53), false).then(texture => this.envmap = texture),
            this.createTexture(__webpack_require__(54), false).then(texture => this.heightmapSphere = texture),
            this.createTexture(__webpack_require__(55), true).then(texture => this.mask = texture),
            this.createTexture(__webpack_require__(56), true).then(texture => this.dirt = texture),
        ]).then(() => {
            // Web Audio API
            ...
            request.open('GET', __webpack_require__(57), true);
...
Object.defineProperty(exports, "__esModule", { value: true });
const FrustumCuller_1 = __webpack_require__(12);
...
let roomJson = __webpack_require__(26);
let hoodlumJson = __webpack_require__(27);
...
class Framebuffer {
    ...
    shadingSphereEnvDisp2(elapsedTime, modelViewMartrix) {
        // this.wBuffer.fill(100);
...
Object.defineProperty(exports, "__esModule", { value: true });
const math_1 = __webpack_require__(0);
const BasicCamera_1 = __webpack_require__(6);
...
module.exports = __webpack_require__.p + "fa2cec5581a807e5634bfb728d2128a5.png";
