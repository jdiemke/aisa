...
Object.defineProperty(exports, "__esModule", { value: true });
var Vector4f_1 = __webpack_require__(5);
exports.Vector4f = Vector4f_1.Vector4f;
var Vector3f_1 = __webpack_require__(0);
exports.Vector3f = Vector3f_1.Vector3f;
var Matrix3_1 = __webpack_require__(11);
exports.Matrix3f = Matrix3_1.Matrix3f;
var Matrix4f_1 = __webpack_require__(12);
...
Object.defineProperty(exports, "__esModule", { value: true });
var BasicCamera_1 = __webpack_require__(4);
exports.BasicCamera = BasicCamera_1.BasicCamera;
var ControllableCamera_1 = __webpack_require__(13);
...
Object.defineProperty(exports, "__esModule", { value: true });
const AISA = __webpack_require__(7);
...
const Framebuffer_1 = __webpack_require__(8);
...
class Canvas {
    ...
    init() {
        Promise.all([
            this.createTexture(__webpack_require__(20), false).then(texture => this.spheremap = texture),
            this.createTexture(__webpack_require__(21), false).then(texture => this.metal = texture),
            this.createTexture(__webpack_require__(22), false).then(texture => this.texture = texture),
            this.createTexture(__webpack_require__(23), true).then(texture => this.texture2 = texture),
            this.createTexture(__webpack_require__(24), false).then(texture => this.texture3 = texture),
            this.createTexture(__webpack_require__(25), true).then(texture => this.texture4 = texture),
            this.createTexture(__webpack_require__(26), false).then(texture => this.texture5 = texture),
            this.createTexture(__webpack_require__(27), true).then(texture => this.texture6 = texture),
            this.createTexture(__webpack_require__(28), true).then(texture => this.texture7 = texture),
            this.createTexture(__webpack_require__(29), false).then(texture => this.texture8 = texture),
            this.createTexture(__webpack_require__(30), false).then(texture => this.texture9 = texture),
            this.createTexture(__webpack_require__(31), true).then(texture => this.texture10 = texture),
            this.createTexture(__webpack_require__(32), true).then(texture => this.texture11 = texture),
            this.createTexture(__webpack_require__(33), true).then(texture => this.texture12 = texture),
            this.createTexture(__webpack_require__(34), true).then(texture => this.texture13 = texture),
            this.createTexture(__webpack_require__(35), false).then(texture => this.texture14 = texture),
        ]).then(() => {
            this.myAudio = new Audio(__webpack_require__(36));
...
Object.defineProperty(exports, "__esModule", { value: true });
const CameraKeyFrame_1 = __webpack_require__(9);
const CameraAnimator_1 = __webpack_require__(10);
const CullFace_1 = __webpack_require__(2);
const Vertex_1 = __webpack_require__(14);
const math_1 = __webpack_require__(1);
const camera_1 = __webpack_require__(3);
const RandomNumberGenerator_1 = __webpack_require__(15);
let json = __webpack_require__(16);
let bunnyJson = __webpack_require__(17);
let worldJson = __webpack_require__(18);
// TODO:
...
class Framebuffer {
    ...
    getBlenderScene() {
        ...
        worldJson.vertices.forEach((v) => {
            points.push(new math_1.Vector4f(v.x, v.y, v.z));
        });
    ...
    drawBlenderScene(elapsedTime) {
        ...
        let scale = 2.0;
        let modelViewMartrix;
        modelViewMartrix = camera.multiplyMatrix(math_1.Matrix4f.constructTranslationMatrix(0, -2.7, 0))
            .multiplyMatrix(math_1.Matrix4f.constructScaleMatrix(scale));
    ...
    drawLensFlare(elapsedTime, texture) {
        let pos = new math_1.Vector3f(Math.round(320 / 2 + Math.sin(elapsedTime * 0.00035) * 110), Math.round(200 / 2 + Math.cos(elapsedTime * 0.0003) * 80), 0);
    ...
    drawMetaballs() {
        let balls = [
            new math_1.Vector3f(Math.sin(Date.now() * 0.002) * 100 + 150, Math.cos(Date.now() * 0.003) * 100 + 100, 0),
            new math_1.Vector3f(Math.sin(Date.now() * 0.001) * 100 + 150, Math.cos(Date.now() * 0.002) * 100 + 100, 0)
        ];
        let index = 0;
        for (let y = 0; y < 200; y++) {
            for (let x = 0; x < 320; x++) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const Vector3f_1 = __webpack_require__(0);
const Vector4f_1 = __webpack_require__(5);
class Matrix4f {
...
Object.defineProperty(exports, "__esModule", { value: true });
const math_1 = __webpack_require__(1);
const BasicCamera_1 = __webpack_require__(4);
