...
class Canvas {
    ...
    render() {
        ...
        this.fpsCount++;
        let time = (Date.now() - this.start) % 260000;
    ...
    init() {
        this.createTexture(__webpack_require__(14), false).then((texture) => {
            this.spheremap = texture;
            this.createTexture(__webpack_require__(15), false).then((texture) => {
                this.metal = texture;
                this.createTexture(__webpack_require__(16), false).then((texture) => {
                                                            ...
                                                            img12.addEventListener("load", () => {
                                                                ...
                                                                img13.addEventListener("load", () => {
                                                                    ...
                                                                    img14.addEventListener("load", () => {
                                                                        ...
                                                                        let myAudio = new Audio(__webpack_require__(17));
                                                                        myAudio.loop = true;
                                                                        this.start = Date.now();
                                                                        myAudio.play();
                                                                        this.renderLoop(0);
                                                                    });
                                                                    img14.src = __webpack_require__(18);
                                                                });
                                                                img13.src = __webpack_require__(19);
                                                            });
                                                            img12.src = __webpack_require__(20);
                                                        });
                                                        img11.src = __webpack_require__(21);
                                                    });
                                                    img10.src = __webpack_require__(22);
                                                });
                                                img9.src = __webpack_require__(23);
                                            });
                                            img8.src = __webpack_require__(24);
                                        });
                                        img7.src = __webpack_require__(25);
                                    });
                                    img6.src = __webpack_require__(26);
                                });
                                img5.src = __webpack_require__(27);
                            });
                            img4.src = __webpack_require__(28);
                        });
                        img3.src = __webpack_require__(29);
                    });
                    img2.src = __webpack_require__(30);
                });
            });
        });
    }
...
class Framebuffer {
    ...
    drawObject(obj, modelViewMartrix, red, green, blue, noLighting = false) {
        ...
        for (let i = 0; i < obj.index.length; i += 3) {
            ...
            if (this.isInFrontOfNearPlane(v1) && this.isInFrontOfNearPlane(v2) && this.isInFrontOfNearPlane(v3)) {
                ...
                this.clipConvexPolygon(new Array(this.project(v1), this.project(v2), this.project(v3)), color, true);
            }
    ...
    fakeSphere(normal) {
        ...
        let tex = new Vertex_1.TextureCoordinate();
    ...
    isTriangleCCW(v1, v2, v3) {
        ...
        return (det < 0) == (this.cullMode == CullFace_1.CullFace.BACK);
    }
    scene10(elapsedTime) {
        this.wBuffer.fill(100);
        let index = [
