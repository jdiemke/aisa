...
Object.defineProperty(exports, "__esModule", { value: true });
const AISA = __webpack_require__(3);
...
class Canvas {
    ...
    render() {
        ...
        this.fpsCount++;
        let time = (Date.now() - this.start) % 70000;
        if (time < 5000) {
                    ...
                    img4.addEventListener("load", () => {
                        ...
                        img5.addEventListener("load", () => {
                            ...
                            img6.addEventListener("load", () => {
                                ...
                                let myAudio = new Audio(__webpack_require__(9));
                                myAudio.loop = true;
                                myAudio.play();
                                this.renderLoop(0);
                            });
                            img6.src = __webpack_require__(10);
                        });
                        img5.src = __webpack_require__(11);
                    });
                    img4.src = __webpack_require__(12);
                });
                img3.src = __webpack_require__(13);
            });
            img2.src = __webpack_require__(14);
        });
...
let json = __webpack_require__(7);
...
class Framebuffer {
     ...
     * @memberof Framebuffer
     */
    clipTriangle(v1, v2, v3, color) {
        let subject = new Array(v1, v2, v3);
        let output = subject;
...
Framebuffer.minWindow = new Vector3f_1.default(0, 10, 0);
Framebuffer.maxWindow = new Vector3f_1.default(319, 190, 0);
