...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/voxel-landscape/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/voxel-landscape/Application.ts":
/*!*****************************************************!*\
  !*** ./src/examples/voxel-landscape/Application.ts ***!
  \*****************************************************/
/*! no static exports found */
...
const VoxelLandscapeScene_1 = __webpack_require__(/*! ./VoxelLandscapeScene */ "./src/examples/voxel-landscape/VoxelLandscapeScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new VoxelLandscapeScene_1.VoxelLandscapeScene());
...
/***/ "./src/examples/voxel-landscape/VoxelLandscapeScene.ts":
/*!*************************************************************!*\
  !*** ./src/examples/voxel-landscape/VoxelLandscapeScene.ts ***!
  \*************************************************************/
/*! no static exports found */
 ...
 */
class VoxelLandscapeScene extends AbstractScene_1.AbstractScene {
    init(framebuffer) {
        return Promise.all([
            texture_1.TextureUtils.load(__webpack_require__(/*! ../../assets/razor1911.png */ "./src/assets/razor1911.png"), true).then((texture) => this.texture2 = texture),
     ...
     */
    drawVoxelLandscape2(framebuffer, texture, time) {
    ...
    drawVoxelLandscape3(framebuffer, texture, time) {
        framebuffer.clearColorBuffer(255 << 24);
        const MIN_DIST = 35;
        const MAX_DIST = 300;
        let camX = time * 0.008;
...
exports.VoxelLandscapeScene = VoxelLandscapeScene;
...
/******/ });
//# sourceMappingURL=voxel-landscape.bundle.js.map