...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/led-plasma/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/led-plasma/Application.ts":
/*!************************************************!*\
  !*** ./src/examples/led-plasma/Application.ts ***!
  \************************************************/
/*! no static exports found */
...
const LedPlasmaScene_1 = __webpack_require__(/*! ./LedPlasmaScene */ "./src/examples/led-plasma/LedPlasmaScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new LedPlasmaScene_1.LedPlasmaScene());
...
/***/ "./src/examples/led-plasma/LedPlasmaScene.ts":
/*!***************************************************!*\
  !*** ./src/examples/led-plasma/LedPlasmaScene.ts ***!
  \***************************************************/
/*! no static exports found */
 ...
 */
class LedPlasmaScene extends AbstractScene_1.AbstractScene {
    init(framebuffer) {
        return Promise.all([
            texture_1.TextureUtils.load(__webpack_require__(/*! ../../assets/led.png */ "./src/assets/led.png"), false).then((texture) => this.ledTexture = texture),
        ]);
    }
    render(framebuffer) {
    ...
    led(framebuffer, elapsedTime, texture) {
...
exports.LedPlasmaScene = LedPlasmaScene;
...
/******/ });
//# sourceMappingURL=led-plasma.bundle.js.map