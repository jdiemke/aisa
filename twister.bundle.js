...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/twister/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/twister/Application.ts":
/*!*********************************************!*\
  !*** ./src/examples/twister/Application.ts ***!
  \*********************************************/
/*! no static exports found */
...
const TwisterScene_1 = __webpack_require__(/*! ./TwisterScene */ "./src/examples/twister/TwisterScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new TwisterScene_1.TwisterScene());
...
/***/ "./src/examples/twister/TwisterScene.ts":
/*!**********************************************!*\
  !*** ./src/examples/twister/TwisterScene.ts ***!
  \**********************************************/
/*! no static exports found */
 ...
 */
class TwisterScene extends AbstractScene_1.AbstractScene {
    init(framebuffer) {
        return Promise.all([
            texture_1.TextureUtils.load(__webpack_require__(/*! ./assets/atlantis.png */ "./src/examples/twister/assets/atlantis.png"), false).then((texture) => this.backgroundTexture = texture),
            texture_1.TextureUtils.load(__webpack_require__(/*! ./assets/logo.png */ "./src/examples/twister/assets/logo.png"), false).then((texture) => this.logoTexture = texture),
        ]);
    }
    render(framebuffer) {
        const time = Date.now();
    ...
    drawSpan(framebuffer, dist, xpos, ypos, scale, texture) {
...
exports.TwisterScene = TwisterScene;


/***/ }),

/***/ "./src/examples/twister/assets/atlantis.png":
/*!**************************************************!*\
  !*** ./src/examples/twister/assets/atlantis.png ***!
  \**************************************************/
/*! no static exports found */
...
/***/ "./src/examples/twister/assets/logo.png":
/*!**********************************************!*\
  !*** ./src/examples/twister/assets/logo.png ***!
  \**********************************************/
/*! no static exports found */
...
/******/ });
//# sourceMappingURL=twister.bundle.js.map