...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/torus-knot/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/torus-knot/Application.ts":
/*!************************************************!*\
  !*** ./src/examples/torus-knot/Application.ts ***!
  \************************************************/
/*! no static exports found */
...
const TorusKnotScene_1 = __webpack_require__(/*! ./TorusKnotScene */ "./src/examples/torus-knot/TorusKnotScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new TorusKnotScene_1.TorusKnotScene());
...
/***/ "./src/examples/torus-knot/TorusKnotScene.ts":
/*!***************************************************!*\
  !*** ./src/examples/torus-knot/TorusKnotScene.ts ***!
  \***************************************************/
/*! no static exports found */
...
const texture_1 = __webpack_require__(/*! ../../texture */ "./src/texture/index.ts");
const math_1 = __webpack_require__(/*! ../../math */ "./src/math/index.ts");
const TorusKnot_1 = __webpack_require__(/*! ../../geometrical-objects/TorusKnot */ "./src/geometrical-objects/TorusKnot.ts");
const RandomNumberGenerator_1 = __webpack_require__(/*! ../../RandomNumberGenerator */ "./src/RandomNumberGenerator.ts");
class TorusKnotScene extends AbstractScene_1.AbstractScene {
    constructor() {
        super(...arguments);
        this.torus = new TorusKnot_1.TorusKnot();
    }
    init(framebuffer) {
        framebuffer.setCullFace(CullFace_1.CullFace.BACK);
        return Promise.all([
            texture_1.TextureUtils.load(__webpack_require__(/*! ../../assets/rave.png */ "./src/assets/rave.png"), false).then(texture => this.rave = texture),
            texture_1.TextureUtils.generateProceduralNoise().then(texture => this.noise = texture)
        ]);
    }
    render(framebuffer) {
        const time = Date.now();
        const elapsedTime = 0.02 * time;
    ...
    shadingTorus5(framebuffer, time) {
        framebuffer.clearDepthBuffer();
        let scale = 1.0;
        let modelViewMartrix = math_1.Matrix4f.constructScaleMatrix(scale, scale, scale).multiplyMatrix(math_1.Matrix4f.constructYRotationMatrix(time * 0.035));
        modelViewMartrix = modelViewMartrix.multiplyMatrix(math_1.Matrix4f.constructXRotationMatrix(time * 0.04));
        ...
        let smash = (framebuffer.cosineInterpolate(0, 15, smashTime) - framebuffer.cosineInterpolate(15, 200, smashTime) +
            ...
            * 12;
        modelViewMartrix = math_1.Matrix4f.constructTranslationMatrix(Math.sin(time * 0.04) * 20, Math.sin(time * 0.05) * 8 - smash * 5, -28 - 250).multiplyMatrix(modelViewMartrix);
        framebuffer.renderingPipeline.draw(this.torus.getMesh(), modelViewMartrix, 200, 100, 100);
    }
}
exports.TorusKnotScene = TorusKnotScene;
...
/***/ "./src/geometrical-objects/TorusKnot.ts":
/*!**********************************************!*\
  !*** ./src/geometrical-objects/TorusKnot.ts ***!
  \**********************************************/
/*! no static exports found */
...
const Vector4f_1 = __webpack_require__(/*! ../math/Vector4f */ "./src/math/Vector4f.ts");
const AbstractGeometricObject_1 = __webpack_require__(/*! ./AbstractGeometricObject */ "./src/geometrical-objects/AbstractGeometricObject.ts");
class TorusKnot extends AbstractGeometricObject_1.AbstractGeometricObject {
    constructor() {
        super();
        const points = [];
        const STEPS = 80;
    ...
    torusFunction3(alpha) {
        let p = 2, q = 3;
        let r = 0.5 * (2 + Math.sin(q * alpha));
        return new Vector4f_1.Vector4f(r * Math.cos(p * alpha), r * Math.cos(q * alpha), r * Math.sin(p * alpha)).mul(70);
    }
}
...
/******/ });
//# sourceMappingURL=torus-knot.bundle.js.map