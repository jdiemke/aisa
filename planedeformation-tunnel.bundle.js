...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/planedeformation-tunnel/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/planedeformation-tunnel/Application.ts":
/*!*************************************************************!*\
  !*** ./src/examples/planedeformation-tunnel/Application.ts ***!
  \*************************************************************/
/*! no static exports found */
...
const PlanedeformationTunnelScene_1 = __webpack_require__(/*! ./PlanedeformationTunnelScene */ "./src/examples/planedeformation-tunnel/PlanedeformationTunnelScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new PlanedeformationTunnelScene_1.PlanedeformationTunnelScene());
...
/***/ "./src/examples/planedeformation-tunnel/PlanedeformationTunnelScene.ts":
/*!*****************************************************************************!*\
  !*** ./src/examples/planedeformation-tunnel/PlanedeformationTunnelScene.ts ***!
  \*****************************************************************************/
/*! no static exports found */
 ...
 */
class PlanedeformationTunnelScene extends AbstractScene_1.AbstractScene {
    init(framebuffer) {
        this.scaleClipBlitter = new ScaleClipBlitter_1.ScaleClipBlitter(framebuffer);
        return Promise.all([
            texture_1.TextureUtils.load(__webpack_require__(/*! ../../assets/heightmap.png */ "./src/assets/heightmap.png"), false).then((texture) => this.heightmap = texture),
            texture_1.TextureUtils.load(__webpack_require__(/*! ../../assets/metall.png */ "./src/assets/metall.png"), false).then((texture) => this.metall = texture),
            texture_1.TextureUtils.load(__webpack_require__(/*! ../../assets/hoodlumLogo.png */ "./src/assets/hoodlumLogo.png"), true).then((texture) => this.hoodlumLogo = texture)
        ]);
    }
    render(framebuffer) {
        ...
        this.scaleClipBlitter.drawScaledTextureClip((320 / 2 - (this.hoodlumLogo.width + smash) / 2) | 0, (200 / 2 - (this.hoodlumLogo.height - smash) / 2) | 0, this.hoodlumLogo.width + smash, (this.hoodlumLogo.height - smash) | 0, this.hoodlumLogo, 1.0);
    }
    /**
     ...
     */
    drawPlanedeformationTunnel(framebuffer, elapsedTime, texture, texture2) {
        let i = 0;
        for (let y = 0; y < 200; y++) {
            for (let x = 0; x < 320; x++) {
                let xdist = (x - 320 / 2);
...
exports.PlanedeformationTunnelScene = PlanedeformationTunnelScene;
...
/******/ });
//# sourceMappingURL=planedeformation-tunnel.bundle.js.map