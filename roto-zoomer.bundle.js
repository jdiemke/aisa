...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/roto-zoomer/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/roto-zoomer/Application.ts":
/*!*************************************************!*\
  !*** ./src/examples/roto-zoomer/Application.ts ***!
  \*************************************************/
/*! no static exports found */
...
const RotoZoomerScene_1 = __webpack_require__(/*! ./RotoZoomerScene */ "./src/examples/roto-zoomer/RotoZoomerScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new RotoZoomerScene_1.RotoZoomerScene());
...
/***/ "./src/examples/roto-zoomer/RotoZoomerScene.ts":
/*!*****************************************************!*\
  !*** ./src/examples/roto-zoomer/RotoZoomerScene.ts ***!
  \*****************************************************/
/*! no static exports found */
 ...
 */
class RotoZoomerScene extends AbstractScene_1.AbstractScene {
    init(framebuffer) {
        return Promise.all([
            texture_1.TextureUtils.load(__webpack_require__(/*! ./assets/logo.png */ "./src/examples/roto-zoomer/assets/logo.png"), false).then((texture) => this.logoTexture = texture),
        ]);
    }
    render(framebuffer) {
        this.drawRotoZoomer(framebuffer, this.logoTexture);
    }
    drawRotoZoomer(framebuffer, texture) {
...
exports.RotoZoomerScene = RotoZoomerScene;


/***/ }),

/***/ "./src/examples/roto-zoomer/assets/logo.png":
/*!**************************************************!*\
  !*** ./src/examples/roto-zoomer/assets/logo.png ***!
  \**************************************************/
/*! no static exports found */
...
/******/ });
//# sourceMappingURL=roto-zoomer.bundle.js.map