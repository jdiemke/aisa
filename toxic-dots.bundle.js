...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/toxic-dots/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/toxic-dots/Application.ts":
/*!************************************************!*\
  !*** ./src/examples/toxic-dots/Application.ts ***!
  \************************************************/
/*! no static exports found */
...
const ToxicDotsScene_1 = __webpack_require__(/*! ./ToxicDotsScene */ "./src/examples/toxic-dots/ToxicDotsScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new ToxicDotsScene_1.ToxicDotsScene());
...
/***/ "./src/examples/toxic-dots/ToxicDotsScene.ts":
/*!***************************************************!*\
  !*** ./src/examples/toxic-dots/ToxicDotsScene.ts ***!
  \***************************************************/
/*! no static exports found */
 ...
 */
class ToxicDotsScene extends AbstractScene_1.AbstractScene {
    constructor() {
        super(...arguments);
        // optimization:
    ...
    shadingTorus3(framebuffer, elapsedTime) {
        let points = [];
        const STEPS = 15 * 2;
        const STEPS2 = 12 * 2;
        for (let i = 0; i < STEPS; i++) {
        ...
        for (let i = 0; i < points2.length; i++) {
            ...
            if (v1.x > Framebuffer_1.Framebuffer.minWindow.x && v1.x < Framebuffer_1.Framebuffer.maxWindow.x &&
                v1.y > Framebuffer_1.Framebuffer.minWindow.y && v1.y < Framebuffer_1.Framebuffer.maxWindow.y) {
...
exports.ToxicDotsScene = ToxicDotsScene;
...
/******/ });
//# sourceMappingURL=toxic-dots.bundle.js.map