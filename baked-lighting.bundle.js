...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/baked-lighting/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/baked-lighting/Application.ts":
/*!****************************************************!*\
  !*** ./src/examples/baked-lighting/Application.ts ***!
  \****************************************************/
/*! no static exports found */
...
const BakedLighting_1 = __webpack_require__(/*! ./BakedLighting */ "./src/examples/baked-lighting/BakedLighting.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new BakedLighting_1.BakedLighting());
...
/***/ "./src/examples/baked-lighting/BakedLighting.ts":
/*!******************************************************!*\
  !*** ./src/examples/baked-lighting/BakedLighting.ts ***!
  \******************************************************/
/*! no static exports found */
 ...
 */
class BakedLighting extends AbstractScene_1.AbstractScene {
    constructor() {
        super(...arguments);
    ...
    init(framebuffer) {
        ...
        this.blenderObj8 = framebuffer.getBlenderScene(__webpack_require__(/*! ../../assets/abstract.json */ "./src/assets/abstract.json"), false);
        this.skyBox = new SkyBox_1.SkyBox();
        return Promise.all([
            this.skyBox.init(),
            texture_1.TextureUtils.load(__webpack_require__(/*! ../../assets/Backed.png */ "./src/assets/Backed.png"), false).then((texture) => this.baked = texture),
    ...
    drawBlenderScene7(framebuffer, elapsedTime, texture, dirt) {
        elapsedTime *= 0.2;
        framebuffer.clearDepthBuffer();
        let camera = math_1.Matrix4f.constructTranslationMatrix(0, 0, -134 + (Math.sin(elapsedTime * 0.00007) * 0.5 + 0.5) * 17).multiplyMatrix(math_1.Matrix4f.constructXRotationMatrix(elapsedTime * 0.0006).multiplyMatrix(math_1.Matrix4f.constructYRotationMatrix(-elapsedTime * 0.0005).multiplyMatrix(math_1.Matrix4f.constructTranslationMatrix(0, -25, 0))));
        let mv = camera.multiplyMatrix(math_1.Matrix4f.constructScaleMatrix(13, 13, 13));
        ...
        let scale = 20;
        let lensflareScreenSpace = framebuffer.project(camera.getRotation().multiply(new math_1.Vector3f(1.1 * scale, 2 * scale, -0.9 * scale)));
        // framebuffer.drawLensFlare(lensflareScreenSpace, elapsedTime * 1.2, texture, dirt);
    }
}
exports.BakedLighting = BakedLighting;
...
/******/ });
//# sourceMappingURL=baked-lighting.bundle.js.map