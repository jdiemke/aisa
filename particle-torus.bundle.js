...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/particle-torus/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/particle-torus/Application.ts":
/*!****************************************************!*\
  !*** ./src/examples/particle-torus/Application.ts ***!
  \****************************************************/
/*! no static exports found */
...
const ParticleTorusScene_1 = __webpack_require__(/*! ./ParticleTorusScene */ "./src/examples/particle-torus/ParticleTorusScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new ParticleTorusScene_1.ParticleTorusScene());
...
/***/ "./src/examples/particle-torus/ParticleTorusScene.ts":
/*!***********************************************************!*\
  !*** ./src/examples/particle-torus/ParticleTorusScene.ts ***!
  \***********************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const Texture_1 = __webpack_require__(/*! ../../texture/Texture */ "./src/texture/Texture.ts");
const TextureUtils_1 = __webpack_require__(/*! ../../texture/TextureUtils */ "./src/texture/TextureUtils.ts");
const Vector3f_1 = __webpack_require__(/*! ../../math/Vector3f */ "./src/math/Vector3f.ts");
const Matrix4f_1 = __webpack_require__(/*! ../../math/Matrix4f */ "./src/math/Matrix4f.ts");
class ParticleTorusScene {
    constructor() {
    ...
    init(framebuffer) {
        this.start = Date.now();
        return Promise.all([
            TextureUtils_1.TextureUtils.load(__webpack_require__(/*! ../../assets/blurredBackground.png */ "./src/assets/blurredBackground.png"), false).then((texture) => this.blurred = texture),
            TextureUtils_1.TextureUtils.generateProceduralParticleTexture().then(texture => this.particleTexture2 = texture),
            TextureUtils_1.TextureUtils.generateProceduralNoise().then(texture => this.noise = texture)
        ]);
    }
    render(framebuffer) {
        const time = Date.now();
        ...
        framebuffer.drawScaledTextureClipBi(Math.round(320 / 2 - width / 2), Math.round(200 / 2 - height / 2), width, height, texture, 1.0);
    ...
    drawParticleTorus(framebuffer, elapsedTime, texture, noClear = false) {
        if (!noClear)
        ...
        for (let i = 0; i < num; i++) {
            ...
            points.push(new Vector3f_1.Vector3f(x, y, z));
        }
        let modelViewMartrix = Matrix4f_1.Matrix4f.constructTranslationMatrix(0, 0, -20)
            .multiplyMatrix(Matrix4f_1.Matrix4f.constructYRotationMatrix(elapsedTime * 0.0003)
            .multiplyMatrix(Matrix4f_1.Matrix4f.constructXRotationMatrix(elapsedTime * 0.0003)));
        let points2 = new Array(points.length);
        points.forEach(element => {
        ...
        points2.forEach(element => {
            ...
            framebuffer.drawParticle(Math.round(element.x) - Math.round(size / 2), Math.round(element.y) - Math.round(size / 2), Math.round(size), Math.round(size), texture, 1 / element.z, 1.0);
        });
    }
}
exports.ParticleTorusScene = ParticleTorusScene;
...
/******/ });
//# sourceMappingURL=particle-torus.bundle.js.map