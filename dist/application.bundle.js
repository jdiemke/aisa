...
class Canvas {
     ...
     */
    render() {
        let time = (Date.now() - this.start) % 60000;
        if (time < 5000) {
                ...
                img3.addEventListener("load", () => {
                    ...
                    img4.addEventListener("load", () => {
                        ...
                        img5.addEventListener("load", () => {
                            ...
                            img6.src = __webpack_require__(12);
                        });
                        img5.src = __webpack_require__(9);
                    });
                    img4.src = __webpack_require__(10);
                });
                img3.src = __webpack_require__(11);
            });
...
let json = __webpack_require__(15);
