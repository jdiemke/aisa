...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/frustum-culling/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/animation/CameraAnimator.ts":
/*!*****************************************!*\
  !*** ./src/animation/CameraAnimator.ts ***!
  \*****************************************/
/*! no static exports found */
...
/***/ "./src/animation/CameraKeyFrame.ts":
/*!*****************************************!*\
  !*** ./src/animation/CameraKeyFrame.ts ***!
  \*****************************************/
/*! no static exports found */
...
/***/ "./src/clustered-culling/BoundingVolumeExpander.ts":
/*!*********************************************************!*\
  !*** ./src/clustered-culling/BoundingVolumeExpander.ts ***!
  \*********************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const Geometry_1 = __webpack_require__(/*! ../math/Geometry */ "./src/math/Geometry.ts");
class BoundingVolumeExpander {
    static expand(scene) {
        return scene.map((mesh) => {
            const sphere = new Geometry_1.ComputationalGeometryUtils().computeBoundingSphere(mesh.points);
            sphere.getCenter().w = 1;
            return [mesh, sphere];
        });
    }
}
exports.BoundingVolumeExpander = BoundingVolumeExpander;
...
/***/ "./src/examples/frustum-culling/Application.ts":
/*!*****************************************************!*\
  !*** ./src/examples/frustum-culling/Application.ts ***!
  \*****************************************************/
/*! no static exports found */
...
const FrustumCullingScene_1 = __webpack_require__(/*! ./FrustumCullingScene */ "./src/examples/frustum-culling/FrustumCullingScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new FrustumCullingScene_1.FrustumCullingScene());
...
/***/ "./src/examples/frustum-culling/FrustumCullingScene.ts":
/*!*************************************************************!*\
  !*** ./src/examples/frustum-culling/FrustumCullingScene.ts ***!
  \*************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const CameraAnimator_1 = __webpack_require__(/*! ../../animation/CameraAnimator */ "./src/animation/CameraAnimator.ts");
const CameraKeyFrame_1 = __webpack_require__(/*! ../../animation/CameraKeyFrame */ "./src/animation/CameraKeyFrame.ts");
const BlenderJsonParser_1 = __webpack_require__(/*! ../../blender/BlenderJsonParser */ "./src/blender/BlenderJsonParser.ts");
const BoundingVolumeExpander_1 = __webpack_require__(/*! ../../clustered-culling/BoundingVolumeExpander */ "./src/clustered-culling/BoundingVolumeExpander.ts");
...
class FrustumCullingScene extends AbstractScene_1.AbstractScene {
    constructor() {
        super(...arguments);
    ...
    init(framebuffer) {
        ...
        this.renderingPipeline.setCullFace(CullFace_1.CullFace.BACK);
        this.world = BoundingVolumeExpander_1.BoundingVolumeExpander.expand(BlenderJsonParser_1.BlenderJsonParser.parse(__webpack_require__(/*! ../../assets/world2.json */ "./src/assets/world2.json")));
        return Promise.all([]);
    }
    render(framebuffer) {
        const time = Date.now();
    ...
    drawBlenderScene(framebuffer, elapsedTime, texture, texture2) {
        // camerea:
        ...
        if (texture2) {
            ...
            points2.forEach(element => {
                ...
                framebuffer.drawSoftParticle(Math.round(element.x - size * 0.5), Math.round(element.y - size * 0.5), Math.round(size), Math.round(size), texture2, 1 / element.z, 1.0);
            });
        }
...
exports.FrustumCullingScene = FrustumCullingScene;
...
/******/ });
//# sourceMappingURL=frustum-culling.bundle.js.map