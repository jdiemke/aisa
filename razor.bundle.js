...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/razor/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/razor/Application.ts":
/*!*******************************************!*\
  !*** ./src/examples/razor/Application.ts ***!
  \*******************************************/
/*! no static exports found */
...
const RazorScene_1 = __webpack_require__(/*! ./RazorScene */ "./src/examples/razor/RazorScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new RazorScene_1.RazorScene());
...
/***/ "./src/examples/razor/RazorScene.ts":
/*!******************************************!*\
  !*** ./src/examples/razor/RazorScene.ts ***!
  \******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const CullFace_1 = __webpack_require__(/*! ../../CullFace */ "./src/CullFace.ts");
const Cube_1 = __webpack_require__(/*! ../../geometrical-objects/Cube */ "./src/geometrical-objects/Cube.ts");
const Dodecahedron_1 = __webpack_require__(/*! ../../geometrical-objects/Dodecahedron */ "./src/geometrical-objects/Dodecahedron.ts");
const Pyramid_1 = __webpack_require__(/*! ../../geometrical-objects/Pyramid */ "./src/geometrical-objects/Pyramid.ts");
const Sphere_1 = __webpack_require__(/*! ../../geometrical-objects/Sphere */ "./src/geometrical-objects/Sphere.ts");
const math_1 = __webpack_require__(/*! ../../math */ "./src/math/index.ts");
 ...
 */
class RazorScene extends AbstractScene_1.AbstractScene {
    constructor() {
        super(...arguments);
    ...
    init(framebuffer) {
        ...
        this.dodecahedron = new Dodecahedron_1.Dodecahedron();
        this.pyramid = new Pyramid_1.Pyramid();
        this.icosahedron = new Sphere_1.Sphere(6, 10);
        return Promise.all([
            texture_1.TextureUtils.load(__webpack_require__(/*! ./assets/spark.png */ "./src/examples/razor/assets/spark.png"), true).then(texture => this.texture10 = texture),
            texture_1.TextureUtils.load(__webpack_require__(/*! ./assets/ring.png */ "./src/examples/razor/assets/ring.png"), true).then(texture => this.texture11 = texture),
            texture_1.TextureUtils.load(__webpack_require__(/*! ./assets/bokeh.png */ "./src/examples/razor/assets/bokeh.png"), true).then(texture => this.texture13 = texture),
            texture_1.TextureUtils.load(__webpack_require__(/*! ./assets/dirt.png */ "./src/examples/razor/assets/dirt.png"), true).then(texture => this.dirt = texture),
    ...
    reproduceRazorScene(framebuffer, elapsedTime, texture, dirt) {
        // camerea:
        ...
        framebuffer.renderingPipeline.draw(model, modelViewMartrix, 239, 187, 115);
        scale = 1.0;
        ...
        framebuffer.renderingPipeline.draw(model, modelViewMartrix, 144, 165, 116);
        scale = 1.0;
        modelViewMartrix = math_1.Matrix4f.constructScaleMatrix(scale, scale, scale);
        ...
        modelViewMartrix = camera.multiplyMatrix(modelViewMartrix);
        model = this.cube.getMesh();
        framebuffer.renderingPipeline.draw(model, modelViewMartrix, 191, 166, 154);
        scale = 1.0;
        modelViewMartrix = math_1.Matrix4f.constructScaleMatrix(scale, scale, scale);
        modelViewMartrix = math_1.Matrix4f.constructTranslationMatrix(-distance, yDisplacement + 0.5, -distance).multiplyMatrix(modelViewMartrix);
        modelViewMartrix = camera.multiplyMatrix(modelViewMartrix);
        model = this.pyramid.getMesh();
        framebuffer.renderingPipeline.draw(model, modelViewMartrix, 125, 128, 146);
        /**
         * SHADOWS
         */
        ...
        framebuffer.renderingPipeline.draw(this.dodecahedron.getMesh(), modelViewMartrix, 48, 32, 24);
        scale = 1.0;
        modelViewMartrix = math_1.Matrix4f.constructScaleMatrix(scale, scale, scale);
        modelViewMartrix = math_1.Matrix4f.constructTranslationMatrix(-distance, yDisplacement + 0.5, -distance).multiplyMatrix(modelViewMartrix);
        modelViewMartrix = camera.multiplyMatrix(math_1.Matrix4f.constructShadowMatrix(modelViewMartrix).multiplyMatrix(modelViewMartrix));
        framebuffer.renderingPipeline.draw(this.pyramid.getMesh(), modelViewMartrix, 48, 32, 24);
        scale = 1.0;
        modelViewMartrix = math_1.Matrix4f.constructScaleMatrix(scale, scale, scale);
        modelViewMartrix = math_1.Matrix4f.constructTranslationMatrix(distance, yDisplacement + 0.5, -distance).multiplyMatrix(modelViewMartrix);
        modelViewMartrix = camera.multiplyMatrix(math_1.Matrix4f.constructShadowMatrix(modelViewMartrix).multiplyMatrix(modelViewMartrix));
        framebuffer.renderingPipeline.draw(this.cube.getMesh(), modelViewMartrix, 48, 32, 24);
        scale = 1.0;
        modelViewMartrix = math_1.Matrix4f.constructScaleMatrix(scale * 0.5, scale * 2, scale * 0.5);
        modelViewMartrix = math_1.Matrix4f.constructTranslationMatrix(-distance, yDisplacement + 1, distance).multiplyMatrix(modelViewMartrix);
        modelViewMartrix = camera.multiplyMatrix(math_1.Matrix4f.constructShadowMatrix(modelViewMartrix).multiplyMatrix(modelViewMartrix));
        ...
        modelViewMartrix = math_1.Matrix4f.constructTranslationMatrix(distance, yDisplacement + 1.0, distance).multiplyMatrix(modelViewMartrix);
        modelViewMartrix = camera.multiplyMatrix(math_1.Matrix4f.constructShadowMatrix(modelViewMartrix).multiplyMatrix(modelViewMartrix));
        framebuffer.renderingPipeline.draw(this.icosahedron.getMesh(), modelViewMartrix, 48, 32, 24);
        let lensflareScreenSpace = framebuffer.project(camera.multiply(new math_1.Vector3f(12.0, 4.0, 0)));
        framebuffer.drawLensFlare(lensflareScreenSpace, elapsedTime * 100, texture, dirt);
    }
}
exports.RazorScene = RazorScene;


/***/ }),

/***/ "./src/examples/razor/assets/bokeh.png":
/*!*********************************************!*\
  !*** ./src/examples/razor/assets/bokeh.png ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./src/examples/razor/assets/dirt.png":
/*!********************************************!*\
  !*** ./src/examples/razor/assets/dirt.png ***!
  \********************************************/
/*! no static exports found */
...
/***/ "./src/examples/razor/assets/ring.png":
/*!********************************************!*\
  !*** ./src/examples/razor/assets/ring.png ***!
  \********************************************/
/*! no static exports found */
...
/***/ "./src/examples/razor/assets/spark.png":
/*!*********************************************!*\
  !*** ./src/examples/razor/assets/spark.png ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./src/geometrical-objects/Cube.ts":
/*!*****************************************!*\
  !*** ./src/geometrical-objects/Cube.ts ***!
  \*****************************************/
/*! no static exports found */
...
class Cube extends AbstractGeometricObject_1.AbstractGeometricObject {
    constructor() {
        super();
        let a = 0.5;
        const points = [
            new Vector4f_1.Vector4f(-a, -a, -a),
            new Vector4f_1.Vector4f(a, -a, -a),
            new Vector4f_1.Vector4f(a, a, -a),
            new Vector4f_1.Vector4f(-a, a, -a),
            new Vector4f_1.Vector4f(-a, -a, a),
...
/***/ "./src/geometrical-objects/Dodecahedron.ts":
/*!*************************************************!*\
  !*** ./src/geometrical-objects/Dodecahedron.ts ***!
  \*************************************************/
/*! no static exports found */
...
const AbstractGeometricObject_1 = __webpack_require__(/*! ./AbstractGeometricObject */ "./src/geometrical-objects/AbstractGeometricObject.ts");
const Vector4f_1 = __webpack_require__(/*! ../math/Vector4f */ "./src/math/Vector4f.ts");
class Dodecahedron extends AbstractGeometricObject_1.AbstractGeometricObject {
    constructor() {
        super();
        ...
        let c = 2 - phi;
        const points = [
            new Vector4f_1.Vector4f(c, 0, a), new Vector4f_1.Vector4f(-c, 0, a), new Vector4f_1.Vector4f(-b, b, b), new Vector4f_1.Vector4f(0, a, c),
            new Vector4f_1.Vector4f(b, b, b), new Vector4f_1.Vector4f(b, -b, b), new Vector4f_1.Vector4f(0, -a, c), new Vector4f_1.Vector4f(-b, -b, b),
            new Vector4f_1.Vector4f(c, 0, -a), new Vector4f_1.Vector4f(-c, 0, -a), new Vector4f_1.Vector4f(-b, -b, -b), new Vector4f_1.Vector4f(0, -a, -c),
            new Vector4f_1.Vector4f(b, -b, -b), new Vector4f_1.Vector4f(b, b, -b), new Vector4f_1.Vector4f(0, a, -c), new Vector4f_1.Vector4f(-b, b, -b),
            new Vector4f_1.Vector4f(1, c, 0), new Vector4f_1.Vector4f(-a, c, 0), new Vector4f_1.Vector4f(-1, -c, 0), new Vector4f_1.Vector4f(a, -c, 0)
        ];
        const index = [
...
/***/ "./src/geometrical-objects/Pyramid.ts":
/*!********************************************!*\
  !*** ./src/geometrical-objects/Pyramid.ts ***!
  \********************************************/
/*! no static exports found */
...
const Vector4f_1 = __webpack_require__(/*! ../math/Vector4f */ "./src/math/Vector4f.ts");
const AbstractGeometricObject_1 = __webpack_require__(/*! ./AbstractGeometricObject */ "./src/geometrical-objects/AbstractGeometricObject.ts");
class Pyramid extends AbstractGeometricObject_1.AbstractGeometricObject {
    constructor() {
        super();
        let phi = (1 + Math.sqrt(5)) * 0.5;
        let a = 0.5;
...
/***/ "./src/geometrical-objects/Sphere.ts":
/*!*******************************************!*\
  !*** ./src/geometrical-objects/Sphere.ts ***!
  \*******************************************/
/*! no static exports found */
...
const Vector4f_1 = __webpack_require__(/*! ../math/Vector4f */ "./src/math/Vector4f.ts");
const AbstractGeometricObject_1 = __webpack_require__(/*! ./AbstractGeometricObject */ "./src/geometrical-objects/AbstractGeometricObject.ts");
class Sphere extends AbstractGeometricObject_1.AbstractGeometricObject {
    constructor(xSteps = 16, ySteps = 16) {
        super();
        const points = [];
        const STEPS = xSteps;
        const STEPS2 = ySteps;
    ...
    sphereFunction(theta, phi) {
        return new Vector4f_1.Vector4f(Math.cos(theta) * Math.cos(phi), Math.cos(theta) * Math.sin(phi), Math.sin(theta), 1.0);
    }
}
...
/******/ });
//# sourceMappingURL=razor.bundle.js.map