...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/examples/moving-torus/Application.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/examples/moving-torus/Application.ts":
/*!**************************************************!*\
  !*** ./src/examples/moving-torus/Application.ts ***!
  \**************************************************/
/*! no static exports found */
...
const MovingTorusScene_1 = __webpack_require__(/*! ./MovingTorusScene */ "./src/examples/moving-torus/MovingTorusScene.ts");
class Application {
    static main() {
        const canvas = new Canvas_1.Canvas(320, 200, new MovingTorusScene_1.MovingTorusScene());
...
/***/ "./src/examples/moving-torus/MovingTorusScene.ts":
/*!*******************************************************!*\
  !*** ./src/examples/moving-torus/MovingTorusScene.ts ***!
  \*******************************************************/
/*! no static exports found */
...
const texture_1 = __webpack_require__(/*! ../../texture */ "./src/texture/index.ts");
class MovingTorusScene extends AbstractScene_1.AbstractScene {
    constructor() {
        super(...arguments);
        this.torus = new Torus_1.Torus();
    }
    init(framebuffer) {
        ...
        return Promise.all([
            texture_1.TextureUtils.load(__webpack_require__(/*! ../../assets/atlantis.png */ "./src/assets/atlantis.png"), true).then((texture) => this.background = texture)
        ]);
    }
    render(framebuffer) {
        const time = Date.now();
     ...
     */
    shadingTorus2(framebuffer, elapsedTime) {
        framebuffer.clearDepthBuffer();
        let modelViewMartrix = math_1.Matrix4f.constructYRotationMatrix(elapsedTime * 0.09);
...
exports.MovingTorusScene = MovingTorusScene;
...
/******/ });
//# sourceMappingURL=moving-torus.bundle.js.map